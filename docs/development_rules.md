...
- `hospital_team1/models_part1/patient.py` -> `tests/test_models/test_patient.py`
- `hospital_team1/queues_part1/heap_priority_queue.py` ->
  `tests/test_queues/test_heap_priority_queue.py`
- `hospital_team1/simulation_part2/engine.py` ->
