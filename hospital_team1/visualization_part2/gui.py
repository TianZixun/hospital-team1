    ...
    def dashboard() -> str:
        ...
        if context["performance_chart_available"]:
            context["performance_chart_url"] = url_for(
                "artifact_file",
                filename="results/performance_comparison.png",
                v=_artifact_mtime("results/performance_comparison.png"),
            )
        else:
        ...
        if context["performance_csv_available"]:
            context["performance_csv_url"] = url_for(
                "artifact_file",
                filename="results/performance_results.csv",
                v=_artifact_mtime("results/performance_results.csv"),
            )
        else:
