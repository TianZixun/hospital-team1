...
def build_queue_snapshot(
    ...
    while patient_index < len(arrived_patients) or not waiting.is_empty():
        next_arrival = (
    ...
    return {
        "records": records,
        "waiting_patients": waiting.get_all_sorted_patients(),
...
def project_waiting_starts(
    ...
    for patient in sorted(waiting_patients):
